...
#define DEFAULT_BORDER_WHITE	1.0f
#define DEFAULT_BORDER_ALPHA	1.0f
#define DEFAULT_BKG_WHITE		1.0f
#define DEFAULT_BKG_ALPHA		0.3f
#define DEFAULT_FONT			[UIFont systemFontOfSize:12.0f]
...
- (id)initWithFrame:(CGRect)frame
{
	...
	if (self != nil)
	{
		...
		self.borderColor = [UIColor colorWithWhite:DEFAULT_BORDER_WHITE alpha:1.0];
